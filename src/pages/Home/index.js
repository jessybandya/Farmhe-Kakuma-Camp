...
<figcaption className="absolute bottom-8 left-2/4 flex w-[calc(100%-4rem)] -translate-x-2/4 justify-between rounded-xl border border-green bg-white/50 py-4 px-6 shadow-lg ">
  <div>
    ...
    <div className="site-main">
                    ...
                    <div className="ttm-fid inside ttm-fid-view-lefticon style1">
                      ...
                      <div className="ttm-fid-contents text-left">{/*ttm-fid-contents*/}
                        <h4 className="ttm-fid-inner">
                          <span data-appear-animation="animateDigits" data-from={0} data-to={478} data-interval={5} data-before data-before-style="sup" data-after data-after-style="sub">478</span>
                        </h4>
                ...
                <div className="layer-content">
                  <div className="spacing-5">
                    ...
                    <div className="section-title clearfix">
                      <div className="title-header">
                        <h5>Why Choose Us?</h5>
                        <h2 className="title">Our Vegan 5+ years experience in Agriculture & Health Education</h2>
                      </div>
                      <div className="heading-seperator">
                        <span />
                      </div>
      ...
      {/* services-section */}
      <section className="ttm-bgcolor-grey">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="ptb-25 text-center">
                <h6 className="mb-0">Don’t hesitate, contact us for better help and services. <a href="/sign-up" className="ttm-textcolor-skincolor"> <u>Let’s get started</u></a></h6>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="ttm-processbox-wrapper">
                <div className="ttm-processbox text-center">
                  ...
                  <div className="featured-content">
                    <div className="featured-title"><h5>Design Consultation</h5></div>
                    <div className="ttm-box-description">Applicants can submit all health-related documents.</div>
                  </div>
                </div>
                <div className="ttm-processbox text-center">
                  <div className="ttm-box-image">
                  ...
                  <div className="featured-content">
                    <div className="featured-title"><h5>Landscape Installation</h5></div>
                    <div className="ttm-box-description">We will conduct a thorough examination of client</div>
                  </div>
                </div>
                <div className="ttm-processbox text-center">
                  <div className="ttm-box-image">
                  ...
                  <div className="featured-content">
                    <div className="featured-title"><h5>Design A Portfolio</h5></div>
                    <div className="ttm-box-description">Based on the checkup results, we'll give consultation.</div>
                  </div>
                </div>
                <div className="ttm-processbox text-center">
                  <div className="ttm-box-image">
                  ...
                  <div className="featured-content">
                    <div className="featured-title"><h5>Prepare clients needs</h5></div>
                    <div className="ttm-box-description">If you needed, patients will be provided with detailed.</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <form id="ttm-quote-form" className="row ttm-quote-form clearfix" method="post" action="#">
                  <div className="col-sm-6 col-md-6">
                    <div className="form-group">
                      <input name="name" type="text" className="form-control with-border bg-white" placeholder="Full Name*" required="required" />
                    </div>
                  </div>
                  <div className="col-sm-6 col-md-6">
                    <div className="form-group">
                      <input name="phone" type="text" placeholder="Phone Number*" required="required" className="form-control with-border bg-white" />
                    </div>
                  </div>
                  <div className="col-sm-6 col-md-6">
                    <div className="form-group">
                      <input name="address" type="text" placeholder="Email Address*" required="required" className="form-control with-border bg-white" />
                    </div>
                  </div>
                  <div className="col-sm-6 col-md-6">
                    <div className="form-group">
                      <input name="subject" type="text" placeholder="Subject" required="required" className="form-control with-border bg-white" />
                    </div>
                  </div>
                  <div className="col-sm-12 col-md-12">
                    <div className="form-group">
                      <textarea name="Massage" rows={4} placeholder="Write A Massage..." required="required" className="form-control with-border bg-white" defaultValue={""} />
                    </div>
                  </div>
      ...
      {/* connect-section */}
      <section className="ttm-row connect-section bg-img6 ttm-bgcolor-darkgrey mt_70 clearfix">
        <div className="container">
          <div className="row">{/* row */}
            <div className="col-lg-12">
              {/* section title */}
              <div className="section-title text-center clearfix">
                <div className="title-header">
                  <h5>F.H.E</h5>
                  <h2 className="title">Talk With Our Experts</h2>
                </div>
                <div className="heading-seperator">
                  <span />
                </div>
          ...
          <div className="row">{/* row */}
            <div className="col-lg-12">
              <div className="text-center">
                <p className="mb-0">We provide marketing services to startups and small businesses to looking for a partner of their <br /> development,</p>
              </div>
            </div>
          </div>{/* row end */}
          <div className="row mt-40 ttm-connect-form">{/* row */}
            <div className="col-md-5 offset-md-1 offset-lg-0 col-lg-3 col-sm-6 col-12">
              <div className="form-group">
                <input name="name" type="text" className="form-control" placeholder="Your Name*" required="required" />
              </div>
            </div>
            <div className="col-md-5 col-lg-3 col-sm-6 col-12">
              <div className="form-group">
                <input name="name" type="text" className="form-control" placeholder="Your Email*" required="required" />
              </div>
            </div>
            <div className="col-md-5 offset-md-1 offset-lg-0 col-lg-3 col-sm-6 col-12">
              <div className="form-group">
            ...
            <div className="col-md-5 col-lg-3 col-sm-6 col-12">
              <div className="form-group">
                <button type="submit" id="start" className="ttm-btn ttm-btn-size-md ttm-btn-bgcolor-skincolor w-100" value> Lets Start to Tallks </button>
              </div>
            </div>
          </div>{/* row end */}
          <div className="row mt-30">
            <div className="col-sm-6 offset-md-1 col-md-5 col-lg-3 offset-lg-3">
              {/*  featured-icon-box */} 
